                    ...
                    <div class="container">
                        <div class="col-md-4">
                            <div class="position-relative form-group">
                                ...
                                @else
                                    <input type="radio" id="Yes" name="is_nid" value="required|" >
                                    <label for="Yes">Yes</label><br>
                                    <input type="radio" id="No" name="is_nid" value="" checked>
                                    <label for="No">No</label><br>
                                @endif
                                @error('is_nid')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="position-relative form-group">
                                @if($data->is_phone == 'required|')
                                    ...
                                    <label for="No">No</label><br>
                                @else
                                    <input type="radio" id="Yes" name="is_phone" value="required|" >
                                    <label for="Yes">Yes</label><br>
                                    <input type="radio" id="No" name="is_phone" value="" checked>
                                    <label for="No">No</label><br>
                                @endif
                                @error('is_phone')
                                    <span class="invalid-feedback" role="alert">
