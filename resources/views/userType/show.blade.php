                ...
                @foreach ($datas as $data)
                    @if($data->is_delete != 1)
                        <tr>
                            ...
                            <td align="center">
                                <form action="{{ route('userType.destroy',$data->id) }}" method="POST">
                
                                    <!-- <a class="btn btn-hover-shine btn-sm btn-pill btn-info" href="#">Show Products</a> -->

                                    <a class="btn btn-hover-shine btn-sm btn-pill btn-primary" style="margin-left: 5px"  href="{{ route('userType.edit',$data->id) }}">Edit</a>
